...
KTUtil.ready(function() {
    ...
    // Init Quick Actions Offcanvas Panel
    KTLayoutReportAction.init('QuickActionReport');
...
var KTLayoutReportAction = function () {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function () {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quickReport_actions_close',
            toggleBy: 'ReportPanel'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTLayoutReportAction;
}
